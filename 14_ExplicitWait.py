...
eleLoading = WebDriverWait(driver, 10).until(expected_conditions.visibility_of_element_located(locatorLaoding))
print("Text : ", eleLaoding.text)
# text = driver.find_element(By.XPATH, '//*[@id="loading"]').text
# print("Text : ", text)

locatorH4 = (By.XPATH, '//*[@id="finish"]/h4')
eleLaoding = WebDriverWait(driver, 10).until(expected_conditions.presence_of_element_located(locatorH4))
...
## presence =>  element is available on HTML page ## may be or may not be visible o
